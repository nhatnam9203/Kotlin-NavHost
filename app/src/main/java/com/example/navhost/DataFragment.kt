...
class DataFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnLinkDataFragment.setOnClickListener {
            val newBundle = Bundle()
            newBundle.apply{
                putString("data1", "test data 1")
                putString("data2", "test data 2")
            }
            findNavController().navigate(R.id.homeFragment, newBundle)
        }
